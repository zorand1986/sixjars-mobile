...
const LoginPage = ({ navigation }) => {
  ...
  return (
    <View style={[flexCenterBasis, appBackgroundColorPrimary, mediumHorizontalPadding]}>
      ...
      <BasicTextInput secureTextEntry={true} containerStyles={smallMarginBottom} placeholder="Password" />
      <Pressable style={[alignments.row, alignments.selfAlignEnd, largeMarginBottom]} onPress={handleForgotPassword}>
